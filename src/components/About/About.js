...
const About = () => {
  ...
  return (
    <>
      <Navbar />
      <div style={main}>
        <section class="bg-white dark:bg-gray-900" style={{ color: "white" }}>
          <div class="container px-6 py-10 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-5">
              <div class="flex flex-col items-center p-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-red-600 dark:border-gray-700 dark:hover:border-transparent">
                <img
                ...
                <p class="mt-2 text-gray-500 capitalize text-center dark:text-gray-300 group-hover:text-gray-300">
              ...
              <div class="flex flex-col items-center p-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-red-600 dark:border-gray-700 dark:hover:border-transparent">
                ...
                <div class="flex mt-3 -mx-2">
                  <a
                    href="https://twitter.com/VishwaGajjar27"
                    class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                    aria-label="Twitter"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.instagram.com/vishwish_gajjar/"
                    class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                    aria-label="Instagram"
                  >
                    <svg
                  ...
                  <a
                    href="https://github.com/Vishwa-gajjar"
                    class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                    aria-label="Github"
                  >
                    <svg
              ...
              <div class="flex flex-col items-center p-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-red-600 dark:border-gray-700 dark:hover:border-transparent">
                ...
                <p class="mt-2 text-center text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">
                  Front End and Backend Developer
                </p>

                <div class="flex mt-3 -mx-2">
                  <a
                    href="https://twitter.com/thecyberneh"
                    class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                    aria-label="Twitter"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.instagram.com/thecyberneh"
                    class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                    aria-label="Instagram"
                  >
                    <svg
                  ...
                  <a
                    href="https://github.com/thecyberneh"
                    class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                    aria-label="Github"
                  >
                    <svg
              ...
              <div class="flex flex-col items-center p-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-red-600 dark:border-gray-700 dark:hover:border-transparent">
                ...
                <div class="flex mt-3 -mx-2">
                  ...
                  <a
                    href="https://www.instagram.com/devdalia.exe/"
                    class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                    aria-label="Instagram"
                  >
                    <svg
              ...
              <div class="flex flex-col items-center p-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-red-600 dark:border-gray-700 dark:hover:border-transparent">
                ...
                <div class="flex mt-3 -mx-2">
                  ...
                  <a
                    href="https://www.instagram.com/shubh_kapadia/"
                    class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                    aria-label="Instagram"
                  >
                    <svg
